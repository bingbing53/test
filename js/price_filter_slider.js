...
function RangeInput(o){
    ...
    this.int = function(){
        ...
        $('div.filter-bar').bind('mousedown',function(e){
            ...
            var perct, perct0, perct1, a, b,
                rangeStartOffset=parseInt($('div.filter-bar-bg').offset().left);
    ...
    this.renderOut = function (a,b){ //a和b是百分数，对应进度条
        ...
        labelTxt+='<em class="jt"></em>';

        $('#priceFilter .filter-label')
            .css('left',(a+b)/2*(612)-20)
            .html(labelTxt);
...
(function handlePriceTag(){
    var map=[[0,5],[8,10],[10,15],[15,20],[20,25],[25,35],[50,100],[100,0]];
